...
import com.mirea.weatherforecastapp.databinding.ForecastViewholderBinding
...
//        return ViewHolder(binding)
    ...
    private val differCallback = object : DiffUtil.ItemCallback<FiveDaysForecastResponseApi.data>() {
        override fun areItemsTheSame(
            oldItem: FiveDaysForecastResponseApi.data,
            newItem: FiveDaysForecastResponseApi.data
        ): Boolean {
